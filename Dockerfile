...
#RUN curl -OL https://go.dev/dl/go1.21.3.linux-amd64.tar.gz
#RUN sudo tar -C /usr/local -xvf go1.21.3.linux-amd64.tar.gz
...
RUN go install github.com/pry0cc/tew@latest
